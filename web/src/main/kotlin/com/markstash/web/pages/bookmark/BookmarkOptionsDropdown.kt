...
interface BookmarkOptionsDropdownProps : RProps {
    var isOpen: Boolean
...
val BookmarkOptionsDropdown = functionalComponent<BookmarkOptionsDropdownProps> { props ->
